...
public class Endpoint : Endpoint<Request, Results<Ok<Response>, BadRequest<string>>>
{
    ...
    public override void Configure()
    {
        ...
        {
            summary.Summary = "Get reservations of logged in member";
            summary.Description = "Get the reservations of the member who is logged in according to the request cookie";
